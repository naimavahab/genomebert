...
def main():
    ...
    tokenizer_path ="30k_unigram_tokenizer.json"
    output_dir = "./model_files_30k_unigram"
    save_model_path = "/home/ec2-user/Genomic_multi/model_files_30k_unigram"
    ...
    tokenized_dataset.save_to_disk("./my_30k_tokenized_dataset") # Specify a directory to save to
   ...
   # eval_strategy="epoch", # also evaluate at the end of each epoch
    ...
    no_cuda=False,
    report_to=["wandb"],
    run_name="modernbert-pretrainmodel-Final30k"
)
