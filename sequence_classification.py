...
def build_my_dataloader(cfg: DictConfig, device_batch_size: int):
    ...
    **Modify this function to train on your own dataset!**
    ...
    '''
    dataset = load_from_disk("input_data/rna_new/rna_9sept")#species2")#rna_new/rna_26")#health_dataset")#rna_new/rna_3/rna") #input_data/prom_dataset") #input_data/health_dataset") #input_data/prom_dataset") #input_data/health_dataset") #input_data/prom_dataset")  #lnc_full/lnc_full
    dataset = dataset.shuffle(seed=42)
  #  dataset = dataset.train_test_split(test_size=0.10) #05)
    if cfg.split=='train':
