        ...
        with tempfile.TemporaryDirectory() as _tmp_dir:
            for filename, saved_content in hf_tokenizer_state.items():
                ...
                if saved_content['file_extension'] == '.json':
                    ...
                    s = 's'#spm.SentencePieceProcessor()
...
def main() :
    ...
    checkpoint_path = './outputs_finetune/rna_26/latest-rank0.pt'#/outputs_finetune/healthdata10ep/latest-rank0.pt'
    output_path = './genome_bert_rna26'
    local_checkpoint_save_location = './genome_bert_local_rna26'
    write_huggingface_pretrained_from_composer_checkpoint(
        checkpoint_path=checkpoint_path,
        output_path=output_path,
        local_checkpoint_save_location=local_checkpoint_save_location)
